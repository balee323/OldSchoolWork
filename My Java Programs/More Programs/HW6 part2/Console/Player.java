...
import java.lang.*;
	 ...
	 public class Player
	 {
		...
		private static Hand[] playerHand;  //declare variable
           ...
           players = numPlayers;
			...
			{	
			 ...
			 Input = JOptionPane.showInputDialog("How Many players (max 3)? Press ! to exit.");  //gets user info
				     ...
				     //method used with default construcor
				public static void createPlayers(int numPlayers)
		    	{
				  ...
				  }//method used with default constructor
			...
			public void Start(int players)
			{
			    ...
			    //method give a specific player one top card
			public void HaveIt(int player)
			{
			 
				playerHand[player].Add();
					}//for
			...
			public String playerHand(int player) 
			{
				...
				return("Player "+player+" hand: "+playerHand[player-1].toString()+"\n");
				}
