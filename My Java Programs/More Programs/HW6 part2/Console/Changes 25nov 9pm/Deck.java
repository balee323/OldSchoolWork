			...
			//  DeckShuffle();
			  ...
			  public void CreateDeck()
			  {
				...
				{	 
				      DeckSize = 0;
						...
						return DeckSize;
						 ...
						 //get an element at top most location
				public Card getCard()
			   {
				  ...
				  return Deck1.get(0);
					...
					//overloaded function - get element at cetain location
				public Card getCard(int cardPosition)
			   {
				...
				{
				 System.out.println("removing bottom Card: "+Deck1.get(cardPosition)+"\n");  //sorta have this set as bottom card
