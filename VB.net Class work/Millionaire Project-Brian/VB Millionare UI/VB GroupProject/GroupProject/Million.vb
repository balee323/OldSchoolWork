Public Class FrmWhoMillionare
    ...
    Private Sub FrmWhoMillionare_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        'testing
        ' MessageBox.Show(InputStr(0))
        ' MessageBox.Show(InputStr(14))
    ...
    Private Sub BtnPlay_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPlay.Click
        ...
        'ShowQuestions(InputStr, GameRound)  'Show first question set. Runs once, then rest is user driven.
        ShowQuestions()  'parameters not needed, since global variables used


    End Sub

    'this sub procedure displays the question and answers in a panel and with radio buttons



    ' Sub ShowQuestions(ByVal InputStr() As String, ByVal GameRound As Integer)
    '                               parameters not needed, global variables
    ...
    Sub PlaySoundYes()
        ...
        My.Computer.Audio.Play("yes.wav", _
    ...
    Sub PlaySoundNo()
        ...
        My.Computer.Audio.Play("no.wav", _
        AudioPlayMode.Background)
    ...
    Sub PlaySoundWin()
        ...
        My.Computer.Audio.Play("million.wav", _
        AudioPlayMode.BackgroundLoop)

        ' My.Computer.Audio.Play("trillion.wav", _  'can only play one at a time, cancels
        ' AudioPlayMode.Background)
